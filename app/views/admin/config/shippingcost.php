<section class="content-header">
    <h1>
        <i class="menu-icon fa fa-truck text-olive"></i> Ajustes 
        <small>Métodos de envío</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?= URL_PATH ?>/admin"><i class="fa fa-home"></i> Inicio</a></li>
        <li><a href="<?= URL_PATH ?>/admin/config"><i class="fa fa-truck"></i> Ajustes</a></li>
        <li class="active">Métodos de envío</li>
