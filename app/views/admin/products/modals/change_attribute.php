<!-- Modal -->
<div class="modal fade" id="modal-change-attribute">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span></button>
                <h4 class="text-muted modal-title">Cambiar atributo</h4>
            </div>
            <form id="form-change-attribute">
                <div class="modal-body">

                    <input type="hidden" id="product_id_change" value="<?= $product->id ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select id="attribute_value_id_change" class="form-control select2" style="width: 100%;" required>
