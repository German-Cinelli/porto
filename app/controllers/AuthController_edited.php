...
class AuthController {
    ...
    public function actionIndex(){
        ...
        //Utils::isLogged_redirect(); //Redirige al index si está logeado
                ...
                if(!$user->isEmpty()){
                    ...
                    if($save){
                        ...
                        **/
                        ...
                        $mailEmail = $email;
                        $mailSubject = 'Bienvenido a Paulina Shoes.';
                        $mailBody = "Buenos días! Para comenzar a comprar en PaulinaShoes es necesario que verifiques tu cuenta de correo electrónico. Podrás hacerlo haciendo <a href='$link'>clic aquí</a>
                            <br> Saluda atte. el equipo de PaulinaShoes."
                            ;
    ...
    public function actionLogin(){
        ...
        * */
        ...
        if($count){
            ...
            if($cookie){
                $message_login = 'Límite de intentos excedido!';
                $include = 'app/views/auth/login.php';
                Response::render('index', [
                    'include' => $include,
                    'title' => 'Ingresar',
        ...
        if(isset($_POST)){
            ...
            $email = isset($_POST['login-email']) ? htmlspecialchars($_POST['login-email']) : false;
            $password = isset($_POST['login-password']) ? htmlspecialchars($_POST['login-password']) : false;
            ...
            if($email && $password){
                ...
                if ($user->isEmpty()){
                    Attempts::hit();
                    $message_login = 'Las credenciales no coinciden!';
                    ...
                    if($user[0]->confirmed == 1){
                        ...
                        Attempts::hit();
                        $message_login = 'Antes de iniciar sesión recuerde verificar su dirección de correo electónico.';
                ...
                $message_login = 'Ingrese correo y contraseña!';
                $include = 'app/views/auth/login.php';
                Response::render('index', [
                    'include' => $include,
                    'title' => 'Ingresar',
        ...
        if($user->isEmpty()){
            ...
            if(!$pw_reset->isEmpty()){
                ...
                if($save){
                    ...
                    $mailEmail = $login;
                    $mailSubject = 'Paulina Shoes - Cambio de clave';
